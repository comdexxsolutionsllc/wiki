        ...
        <div role="tabpanel">
            ...
            <div class="tab-content">
                <div class="s-groups-con">
                    ...
                    <div class="">
                        <form action="{{ route('roles.update', [ $team->slug, $role->slug ]) }}" method="POST"
                              role="form">
                            {{ method_field('patch') }}
                            <div class="form-group {{ $errors->has('role_name') ? 'has-error' : '' }} with-icon">
                                ...
                                <i class="fa fa-users icon"
                                   style="{{ $errors->has('role_name') ? 'line-height: 0.9;' : 'line-height: 2.8;' }}"></i>
                            ...
                            <div class="form-group">
                                ...
                                <select multiple="" name="permissions[]" class="form-control" id="permissions-select"
                                        data-val="<?php echo json_encode($selectedPermissions); ?>">
                            ...
                            <ul class="list-unstyled list-inline pull-right">
                                <li>
                                    <a href="{{ route('roles.index', [$team->slug, ])  }}"
                                       class="btn btn-default pull-right">Close</a>
                                </li>
                                <li>
