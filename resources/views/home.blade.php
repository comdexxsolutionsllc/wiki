            ...
            <div>
                <div style="padding: 109px 0px;" class="text-center">
                    ...
                    <h1 style="line-height: 52px;font-size: 38px; font-weight: 700; width: 610px; margin: auto auto 24px;color: white;font-weight: 100;">
                        Opus lets you work more collaboratively and get more done.</h1>
                    <p class="minor-text"
                       style="font-size: 17px;width: 550px;margin: auto auto 24px;font-weight: normal;color: white;">
                        Opus let you work more collaboratively to document who you are, what you do and how to achieve
                        results.</p>
            ...
            <div style="width: 1130px; margin: auto;">
                <div class="row no-container">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
                        Copyright © {{ date("Y") }} <a href="mailto:ziishaned@gmail.com" style="text-decoration: none;">Zeeshan
                            Ahmed</a>
                    </div>
                </div>
            </div>
