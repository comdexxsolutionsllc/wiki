                    ...
                    <div class="row no-container">
                        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                            <div class="wiki-info" style="border-bottom: 0px;">
                                <h2>Wiki Overview</h2>
                                <hr>
                                <form action="{{ route('wikis.overview.update', [$team->slug, $space->slug, $wiki->slug]) }}"
                                                ...
                                                <select name="space" id="space" class="form-control"
                                                    ...
                                                    @foreach($spaces as $space)
                                                        <option value="{{ $space->id }}"
                                                                @if($wiki->space_id === $space->id) selected @endif>{{ $space->name }}</option>
                                                    @endforeach
                                                </select>
                                                @if($errors->has('space'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="outline" class="form-control" id=""
                                               value="{{ $wiki->outline }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-success"><i class="fa fa-save fa-fw"
                                ...
                                <div class="panel-body">
                                    <div class="wiki-overview">
                                        <div style="margin-bottom: 4px;">
                                            ...
                                            <p>
                                                <a href="{{ route('users.show', [$team->slug, $wiki->user->slug]) }}">{{ $wiki->user->name }}</a>
                                            </p>
                                        </div>
                                        <div style="margin-bottom: 4px;">
                                        ...
                                        <div>
                                            ...
                                            <div class="pull-right label label-default"
                                                 style="position: relative; top: 4px;">{{ $wiki->pages->count() }}</div>
                    ...
                    <div class="row no-container">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="delete-team" style="border-bottom: 0px;">
                                ...
                                <a href="{{ route('wikis.destroy', [$team->slug, $space->slug, $wiki->slug]) }}"
                                   class="btn btn-danger" data-method="delete" data-confirm="Are you sure?"
                                   style="padding: 5px 6px;"><i class="fa fa-trash fa-fw"></i> Yes I understand, delete
                                    this wiki</a>
                            </div>
                        </div>
                    </div>
