...
@section('content')
    <div class="aside-content create-wiki-aside" style="margin-top: 0; padding-bottom: 0;">
        <form action="{{ route('wikis.update', [$team->slug, $wiki->space->slug, $wiki->slug ]) }}" method="POST"
              role="form" class="create-wiki-form">
            {{ method_field('patch') }}
            <textarea name="description" class="form-control" data-height="555"
                      id="wiki-description">{{ $wiki->description }}</textarea>
            <div class="row no-container" style="margin-top: 15px;">
                ...
                <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                    ...
                    <a href="{{ route('wikis.show', [$team->slug, $space->slug, $wiki->slug]) }}"
