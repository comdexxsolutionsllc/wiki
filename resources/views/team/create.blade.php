...
@section('content')
    <div class="home-con">
        ...
        <div class="login-page">
            <div class="login-form-con" style="margin-bottom: 24px;">
                ...
                <form action="{{ route('team.store') }}" method="POST" role="form">
                    ...
                    <div class="form-group {{ $errors->has('team_name') ? 'has-error' : '' }}">
                        ...
                        <input type="text" name="team_name" class="form-control" id="team-name" autocomplete="off"
                               required>
            ...
            <p class="text-center"><span class="text-muted" style="margin-left: 15px;">Already have a team?</span> <a
                        href="{{ route('team.login') }}"> Login now</a></p>
        </div>
    </div>
@endsection
