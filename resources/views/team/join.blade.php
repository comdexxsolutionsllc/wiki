            ...
            <div class="login-form-con">
                ...
                <form action="{{ route('team.postjoin', [$team->slug, $hash]) }}" method="POST" role="form">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $team->name }}" name="team_name" class="form-control"
                               id="team-name" autocomplete="off" required readonly>
                    </div>
                    <div class="form-group">
                        <label for="email" class="control-label">Email</label>
                        <input name="email" id="email" type="email" class="form-control"
                               value="{{ $invitation->email }}" required readonly>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
                                <label for="first-name" class="control-label">First name</label>
                                <input name="first_name" value="{{ old('first_name') }}" id="first-name" type="text"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group {{ $errors->has('last_name') ? 'has-error' : '' }}">
                                ...
                                <input name="last_name" value="{{ old('last_name') }}" id="last-name" type="text"
                    ...
                    <div style="margin-top: 15px;">
                        <input type="submit" class="btn btn-success" value="Join"> <span class="text-muted"
                                                                                         style="margin-left: 15px;">Already joined a team?</span>
                        <a href="{{ route('team.login') }}"> Login now</a>
                    </div>
                </form>
            </div>
        </div>
