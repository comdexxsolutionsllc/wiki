            ...
            <div class="tab-content">
                <div class="team-info">
                    ...
                    <p class="text-muted action-info">
                        Renaming team name will also change the team URL and will render all bookmarks to team pages
                        invalid.
                    </p>
                    <form action="{{ route('teams.update', [ $team->slug ]) }}" method="POST" class="form-inline"
                          role="form">
                        {{ method_field('patch') }}
                ...
                <div class="team-logo">
                    ...
                    <div class="media">
                        <div class="pull-left">
                            @if($team->team_logo)
                                <img src="/img/avatars/{{ $team->team_logo }}" alt="" width="155" height="155"
                                     class="media-object" style="border-radius: 3px;">
                            @else
                        ...
                        <div class="media-body avatar-upload-form-con">
                            <form action="{{ route('teams.logo', [ $team->slug ]) }}" enctype="multipart/form-data"
                                  id="avatar-upload-form" method="POST">
                ...
                <div class="delete-team">
                    ...
                    <form action="{{ route('teams.destroy', [ $team->slug ]) }}" method="POST" role="form">
                        {{ method_field('delete') }}
                        <button type="submit" class="btn btn-danger"><i class="fa fa-trash fa-fw"></i> Yes I understand,
                            delete my account
                        </button>
                    </form>
                </div>
