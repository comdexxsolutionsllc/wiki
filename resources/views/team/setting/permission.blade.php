                    ...
                    <div class="s-groups-body">
                        <div class="table-responsive" style="margin-top: 30px;">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <th></th>
                                    <th colspan="2" width="18%" class="text-center" style="font-family: lato;">Teams
                                    </th>
                                    <th colspan="2" width="18%" class="text-center" style="font-family: lato;">
                                        Comments
                                    </th>
                                    <th colspan="2" width="18%" class="text-center" style="font-family: lato;">Pages
                                    </th>
                                </tr>
                                <tr>
