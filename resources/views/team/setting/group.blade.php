                            ...
                            <div class="panel panel-default s-group-item">
                                <div class="panel-body">
                                    <div class="group-item-header">
                                        <div class="pull-left">
                                            <p class="group-name"><span class="name-inner">{{ $group->name }}</span>
                                                <span class="label label-default">{{ $group->members->count() }}</span>
                                            </p>
                                        </div>
                                        <div class="pull-right">
                                            <ul class="list-unstyled list-inline">
                                                <li>
                                                    <a href="{{ route('roles.edit', [$team->slug, $group->slug]) }}"><i
                                                                class="fa fa-pencil fa-fw" data-toggle="tooltip"
                                                                data-placement="top" title="Edit"></i></a>
                                                </li>
                                                @if($group->slug !== 'admins')
                                                    <li>
                                                        <a href="{{ route('roles.delete', [$team->slug, $group->slug]) }}"
                                                        ...
                                                        <a class="pull-left group-member-img" href="#">
                                                            @if($member->profile_image)
                                                                <img class="media-object"
                                                                     ...
                                                                     data-original-title="{{ $member->first_name . ' ' . $member->last_name }}">
                                                            @else
