        ...
        <div role="tabpanel">
            ...
            <div class="tab-content">
                <div class="integration-content" style="width: 400px; margin: auto; margin-top: 32px;">
                    ...
                    <form action="{{ route('integrations.store', [$team->slug, ]) }}" method="POST" role="form"
                            ...
                            <div class="row">
                                    ...
                                    <div class="checkbox" style="margin-top: 0;">
                                        <label>
                                            <input type="checkbox" name="integrations[]"
                                                   value="1" {{ in_array('1', old('integrations', [])) ? 'checked' : '' }}>
                                            Created
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="integrations[]"
                                                   value="2" {{ in_array('2', old('integrations', [])) ? 'checked' : '' }}>
                                            Updated
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="integrations[]"
                                                   value="3" {{ in_array('3', old('integrations', [])) ? 'checked' : '' }}>
                                            Deleted
                                        </label>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="checkbox" style="margin-top: 0;">
                                        <label>
                                            <input type="checkbox" name="integrations[]"
                                                   value="4" {{ in_array('4', old('integrations', [])) ? 'checked' : '' }}>
                                            Created
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="integrations[]"
                                                   value="5" {{ in_array('5', old('integrations', [])) ? 'checked' : '' }}>
                                            Updated
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="integrations[]"
                                                   value="6" {{ in_array('6', old('integrations', [])) ? 'checked' : '' }}>
                                            Deleted
                                        </label>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="checkbox" style="margin-top: 0;">
                                        <label>
                                            <input type="checkbox" name="integrations[]"
                                                   value="7" {{ in_array('7', old('integrations', [])) ? 'checked' : '' }}>
                                            Created
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="integrations[]"
                                                   value="8" {{ in_array('8', old('integrations', [])) ? 'checked' : '' }}>
                                            Updated
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="integrations[]"
                                                   value="9" {{ in_array('9', old('integrations', [])) ? 'checked' : '' }}>
                                            Deleted
                                        </label>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="checkbox" style="margin-top: 0;">
                                        <label>
                                            <input type="checkbox" name="integrations[]"
                                                   value="10" {{ in_array('10', old('integrations', [])) ? 'checked' : '' }}>
                                            Someone join team
                                        </label>
                                    </div>
                                </div>
