                    ...
                    <div class="row no-container">
                        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                            <div class="wiki-info" style="border-bottom: 0px;">
                                <h2>Page Overview</h2>
                                <hr>
                                <form action="{{ route('pages.overview.update', [$team->slug, $space->slug, $wiki->slug, $page->slug]) }}"
                                                    ...
                                                    @foreach($pages as $item)
                                                        @if($page->id != $item->id)
                                                            <option value="{{ $item->id }}"
                                                                    @if($item->id === $page->parent_id) selected @endif>{{ $item->name }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="outline" class="form-control" id="description"
                                               value="{{ $page->outline }}">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="panel-body">
                                    <div class="wiki-overview">
                                        <div style="margin-bottom: 4px;">
                                            ...
                                            <p>
                                                <a href="{{ route('users.show', [$team->slug, $page->user->slug]) }}">{{ $page->user->name }}</a>
                                            </p>
                                        </div>
                                        <div style="margin-bottom: 4px;">
