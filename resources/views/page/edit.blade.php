    ...
    <div class="aside-content create-wiki-aside">
        <div class="row no-container">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <form action="{{ route('pages.update', [$team->slug, $wiki->space->slug, $wiki->slug, $page->slug ]) }}"
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="outline" id="outline" value="{{ $page->outline }}"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" data-height="380"
                                  id="wiki-description">{{ $page->description }}</textarea>
                    </div>
                    <button type="submit" class="btn btn-primary pull-right">Save</button>
                    <a href="{{ route('pages.show', [$team->slug, $space->slug, $wiki->slug, $page->slug]) }}"
                       class="btn btn-link pull-right">Cancel</a>
