        ...
        <div role="tabpanel">
            ...
            <div class="tab-content">
                    ...
                    <div class="media">
                        <div class="pull-left">
                            @if(Auth::user()->profile_image)
                                <img src="/img/avatars/{{ Auth::user()->profile_image }}" alt="" width="155"
                                     height="155" class="media-object" style="border-radius: 3px;">
                            @else
                        ...
                        <div class="media-body avatar-upload-form-con">
                            <form action="{{ route('users.avatar', [ $team->slug, Auth::user()->slug ]) }}"
                                  enctype="multipart/form-data" id="avatar-upload-form" method="POST">
                ...
                <div class="user-info">
                    ...
                    <form action="{{ route('users.update', [$team->slug, Auth::user()->slug]) }}" method="POST"
                          role="form">
                        {{ method_field('patch') }}
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" id="first-name" class="form-control input"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="last_name" id="last-name" class="form-control input"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" id="email" class="form-control input"
                                   value="{{ Auth::user()->email }}" required="required" autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label for="timezone">Time zone</label>
                            <select class="form-control" name="timezone" id="timezone"
                                    data-selected="{{ Auth::user()->timezone }}">
