...
<div class="container">
    <div style="width: 580px;">
        ...
        <p>Hello {{ $email }}!</p>
        <p style="margin-bottom: 18px;">Someone has requested a link to change your password. You can do this through
            the link below.</p>
        <a href="{{ url('/password/reset/'.$token) }}" class="btn btn-success"
           style="text-decoration: none; border-radius: 0px; margin-bottom: 18px;">Change my password</a>
