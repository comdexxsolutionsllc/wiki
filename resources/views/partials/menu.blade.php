            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right"
                        ...
                        <li><a href="{{ route('wikis.create', [ $team->slug ]) }}" style="padding: 5px 6px;">Create
                                wiki</a></li>
                        <li><a href="{{ route('spaces.create', [ $team->slug ]) }}" style="padding: 5px 6px;">Create
                                space</a></li>
                        <li class="divider" style="margin: 0px;"></li>
                        <li><a href="{{ route('teams.settings.members', [$team->slug,]) }}" style="padding: 5px 6px;">Invite
                                user</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" style="margin-top: -3px; padding: 4px 5px;">
                        <li><a href="{{ route('users.show', [$team->slug, Auth::user()->slug]) }}"
