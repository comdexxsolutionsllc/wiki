...
class Team extends Model
{
    ...
    {
        return $this->hasMany(Activity::class, 'team_id', 'id')->with([
            'user',
    ...
    {
        $user = DB::table('users')->join('user_teams', 'users.id', '=', 'user_teams.user_id')->join('teams', 'user_teams.team_id', '=', 'teams.id')->where('teams.name', '=', $passwordReset->team_name)->where('users.email', '=', $passwordReset->email)->select('users.*')->first();
