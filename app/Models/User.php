...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(Activity::class, 'user_id', 'id')->with([
    ...
    {
        $user = $this->join('user_teams', 'users.id', '=', 'user_teams.user_id')->join('teams', 'user_teams.team_id', '=', 'teams.id')->where('teams.name', '=', $data['team_name'])->where('users.email', '=', $data['email'])->select('users.*', 'teams.slug as team_slug')->first();
